...
export class WorkerCoach {
  ...
  driveLicenseNo:string;  //驾驶证号
  driveCarType:string;  //准驾类型
  driveLicenseGetTime:string;  //驾驶证初领时间
  licenseGrantOrga:string;  //发证机关
  ...
  teachType:string;  //准教类型
  teachCarType:string;  //准教车型
  driveLicenseSituation:string;  //证照状态
